...
class MyCustomDataset(Dataset):
    def __init__(self, root_path, sample_rate=32000, resample_rate=32000, classes_num=527, 
        ...
        folder_list = ["Vehicle_horn", "Baby_cry", "Whistle", "Glass"]
        ...
        self.labels = np.array([0]*self.num_class[0] + [1]*self.num_class[1] + [2]*self.num_class[2] + [3]*self.num_class[3])
...
# ------------------------------ debugging ------------------------------
dataset = MyCustomDataset(root_path="../audioset-processing/output")

myCustomDataset = MyCustomDataset("../audioset-processing/output")

dl = DataLoader(myCustomDataset,
                shuffle=True,
